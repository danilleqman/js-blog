export function renderPost(post, options = {}) {
  ...
  let btnDel = `<button class="button-round button-small button-danger" data-id="${options.id}" data-title="${post.title}">Удалить</button>`;
  ...
  return `
    <div class="panel">
      ...
      <div class="panel-footer w-panel-footer">
        ...
        ${options.delButton ? btnDel : (options.withButton ? button : '')}
      </div>
    </div>
  `;
}